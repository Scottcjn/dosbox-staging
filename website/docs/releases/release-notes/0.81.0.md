...
<figure markdown>
  ![Price of Persia (default)](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/pop-hercules.png){ loading=lazy }
...
<figure markdown>
  ![Price of Persia (aspect ratio corrected )](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/pop-hercules-aspect-corrected.jpg){ loading=lazy }
...
<figure markdown>
  ![Multikolor by kolor --- Black vertical bars issue](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/multikolor-buggy.png){ loading=lazy }
...
<figure markdown>
  ![Multikolor by kolor --- After the fix)](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/multikolor-fixed.png){ loading=lazy }
...
<figure markdown>
  ![Angel Devoid: Face of the Enemy --- raw output](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/angel-devoid-raw.png){ loading=lazy }
...
<figure markdown>
  ![Angel Devoid: Face of the Enemy --- raw output](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/angel-devoid-fixvideo.png){ loading=lazy }
...
<figure markdown>
  ![Gods -- 320&times;200 VGA](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/angel-devoid-fixvideo-scanline.png){ loading=lazy }
...
??? note "Full PR list of graphics-related changes"
    ...
    - Include low width resolution in VGA scanning criteria (#2582)
...
| Game                                          | Audio example                                                                                                                 |
| --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Quest for Glory: So You Want to Be a Hero   | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/imfc-quest-for-glory.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
| The Colonel's Bequest -- Intro 1   | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/imfc-colonels-bequest-1.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
| The Colonel's Bequest -- Intro 2   | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/imfc-colonels-bequest-2.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
| The Colonel's Bequest -- Intro 3   | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/imfc-colonels-bequest-3.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
...
<figure markdown>
  ![Output of the improved MIXER /LISTMIDI command](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/mixer-listmidi.png){ loading=lazy }
...
| &nbsp;                                         | &nbsp;
| --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Descent -- Level 8 (SC-55) ¹  | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/descent-level-8-scva.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
| Descent -- Level 8 (FluidSynth buggy) ² | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/descent-level-8-fluidsynth-bug-0.80.1.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
| Descent -- Level 8 (FluidSynth fixed) ³  | <audio controls src="https://www.dosbox-staging.org/static/audio/release-notes/0.81.0/descent-level-8-fluidsynth-fixed.mp3"> Your browser does not support the <code>audio</code> element.</audio>   |
...
??? note "Full PR list of sound-related changes"
    ...
    - Accumulate GUS frames across each voice instead of per-sample (#2696) (#2698)
...
<figure markdown>
  ![New run with log window macOS shortcut](https://www.dosbox-staging.org/static/images/release-notes/0.81.0/macos-logging-shortcut.png){ width=85% loading=lazy }
</figure>
...
??? note "Full PR list of miscellaneous enhancements"
    ...
    - Turn down loguru verbosity when started with following arguments (#2722)
...
??? note "Full PR list of miscellaneous fixes"
    ...
    - Zero initialize memory allocation in GrowWriteMask in dyn_cache (#2986)
...
??? note "Full PR list of project maintenance related changes"
    ...
    - Drop Visual Studio 2019-specific accommodations in `.clang-format`  (#2489)
